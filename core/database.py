...
from core.schemas import Image, Embedding256, Embedding512, Embedding128
...
class VectorRepository:
    ...
    def add_embedding_256(self, image_id, vector_type, parameters, embedding, created_at=None):
        emb = Embedding256(
            image_id=image_id,
    ...
    def add_embedding_512(self, image_id, vector_type, parameters, embedding, created_at=None):
        """
    ...
    def add_embedding_128(self, image_id, vector_type, parameters, embedding, created_at=None):
        emb = Embedding128(
            image_id=image_id,
            vector_type=vector_type,
            parameters=parameters,
    ...
    def get_embeddings_256(self, image_id=None, vector_type=None, param_filter=None):
        ...
        if param_filter is not None:
            for k, v in param_filter.items():
                query = query.filter(Embedding256.parameters[k].astext == str(v))
        return query.all()
    ...
    def get_embeddings_512(self, image_id=None, vector_type=None, param_filter=None):
        ...
        if param_filter is not None:
            for k, v in param_filter.items():
                query = query.filter(Embedding512.parameters[k].astext == str(v))
        return query.all()
    ...
    def get_embeddings_128(self, image_id=None, vector_type=None, param_filter=None):
        ...
        if param_filter is not None:
            for k, v in param_filter.items():
                query = query.filter(Embedding128.parameters[k].astext == str(v))
        return query.all()

...
def test_common_orchestration_notebook_preserves_quick_full_contract() -> None:
    ...
    for phrase in (
        ...
        "FAITHFULNESS_MAXIMUM_SAMPLES는 None 또는 양의 정수여야 합니다.",
...
def test_step1_characterization_and_report_remain_fallback_free() -> None:
    ...
    for phrase in (
        ...
        "pq_sdc_exhaustive",
        "MODEL_UID =",
        "DATASETS = OPEN_SET_REPORT_DATASETS",
        "RUN_IDS = None",
        "select_model_uid_report_cohort",
        "MODEL_RUN_MATRIX_MODEL_UIDS",
        "RUN_CROSS_MODEL_MATRIX",
        '"cross_model_matrix"] = {"status": "disabled"}',
        "select_model_uid_report_matrix",
        "model_uid_complete_campaign_auto_selection",
        "SDC all-or-none",
        '"sdc_comparison_contract"',
        '"sdc_included"',
        'FAITHFULNESS_MAXIMUM_SAMPLES = "auto"',
        ...
        'missing_policy="omit"',
        "omitted_missing_optional_manifest",
        ...
        "survface_tpir20_comparison.csv",
